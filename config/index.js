...
/*
  Application configuration:
    - Environment settings here are the same across all environments.
    - To override settings locally, rename "user.example.js" to "user.js"
*/
let config = {}
...
// Options for Sequelize ORM connection:
//   overrides in production and test environments
